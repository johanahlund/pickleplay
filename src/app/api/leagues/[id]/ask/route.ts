...
const SYSTEM_PROMPT = [
  ...
  "   - Bad: headline says \"Yes\", details say \"…but only if you've played 2 matches\". The restriction is part of the answer.",
  "   - Good: headline says \"Yes, if you've played at least 2 regular-season matches.\"",
  "   - Bad: headline says \"You can repeat categories\", details say \"…but only with different players, max 1 repeat per category\". Those are the conditions.",
  "   - Good: headline says \"Yes — max 1 repeat per category, and only with different players.\"",
  ...
  "",
  "Good example (user asked \"Can I play in the final?\" in English — restriction in headline):",
  "Yes, but only if you've played at least 2 regular-season matches for your team.",
  "## Why this rule",
  "Eligibility is set in the Structure section to keep finals competitive.",
  "",
  "Good example (user asked \"Posso repetir uma categoria?\" in Portuguese — both conditions in headline):",
  "Sim — no máximo 1 repetição por categoria, e tem de ser com atletas diferentes.",
  "## Limite total",
  "Até 8 jogos por encontro contando as repetições.",
  "",
  "BAD example (DO NOT do this — restriction hidden in section):",
