    ...
    include: {
      ...
      matches: {
        include: {
          ...
          // League-game link, if the match was generated by a league lineup
          // or marked as a league friendly. Drives Principal/Friendly badges.
          leagueGame: { select: { id: true, isPrincipal: true, lineupGenerated: true, category: { select: { id: true, name: true } } } },
        },
