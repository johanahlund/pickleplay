...
export function RoleTogglePill() {
  ...
  return (
    <div className="fixed left-3 bottom-20 z-[60]" ref={ref}>
      <button
      ...
      {open && (
        <div className="absolute bottom-9 left-0 bg-white rounded-xl shadow-xl border border-border overflow-hidden min-w-[130px]">
